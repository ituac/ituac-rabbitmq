 ...
 */
@Component
public class AndunTTMailReceiver implements MessageListener {

    private static final Logger log = LoggerFactory.getLogger(AndunTTMailReceiver.class);
    ...
    public void onMessage(Message message) {
        try {
            ...
            if(jsonNode!=null){
                System.out.println("recess>>>>>> success： " + jsonData.get("content").asText());
