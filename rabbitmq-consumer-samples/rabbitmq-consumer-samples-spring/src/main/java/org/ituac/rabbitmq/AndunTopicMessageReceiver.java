...
@Component
public class AndunTopicMessageReceiver implements MessageListener {
	
    private static final Logger log = LoggerFactory.getLogger(AndunTopicMessageReceiver.class);
    ...
    public void onMessage(Message message) {
        try {
            ...
            if(jsonNode!=null)
                System.out.println("method  onMessage>>>>>>> success： " + jsonNode.asText());
