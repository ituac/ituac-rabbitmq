...
@Component
public class AndunACSourceReceiver implements MessageListener {
	
    private static final Logger log = LoggerFactory.getLogger(AndunACSourceReceiver.class);
    ...
    public void onMessage(Message message) {
        try {
            ...
            if(jsonNode!=null){
                System.out.println("成功路由到，这是>>>>>>> success： " + jsonData.get("content").asText());
