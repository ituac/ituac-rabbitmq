...
@Component
public class AndunFanoutSHReceiver implements MessageListener {
	
    private static final Logger log = LoggerFactory.getLogger(AndunFanoutSHReceiver.class);
    ...
    public void onMessage(Message message) {
        try {
            ...
            if(jsonNode!=null){
                System.out.println("上海收到>>>>>>> success： " + jsonData.get("content").asText());
