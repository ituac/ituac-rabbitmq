...
@Component
public class AndunACBackReceiver implements MessageListener {
	
    private static final Logger log = LoggerFactory.getLogger(AndunACBackReceiver.class);
    ...
    public void onMessage(Message message) {
        try {
            ...
            if(jsonNode!=null) {
                System.out.println("错误路由到，这是>>>>>>> success： " + jsonData.get("content").asText());
